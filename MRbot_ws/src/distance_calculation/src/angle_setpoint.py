...
class DistanceSetpoint(object):
    ...
    def __init__(self):
        ...
        #If below 10.0, the PID controller freaks out for unknown reasons
        rate = 30.0
        ...
        self.pub = rospy.Publisher("angle_setpoint", Float64, queue_size=10)
    ...
    def timer_cb(self, _event):
        ...
        msg.data = rospy.get_param("~angle_setpoint", self.message)
        self.message = msg
    ...
    def reconfigure_cb(self, config, dummy):
        ...
        self.message = config["angle_setpoint"]
...
if __name__ == "__main__":
    ...
    rospy.init_node("angle_setpoint")
